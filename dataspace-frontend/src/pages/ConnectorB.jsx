...
import ApiRequestPanelB from "../components/ApiRequestPanelB";

const ConnectorBPage = () => {
  ...
  const fetchConnectorData = async () => {
    ...
    try {
      const res = await fetch("/connectorb");
  ...
  return (
    <Box
      ...
      alignItems="center" // vertically center both panels
      width="100%"
      minHeight="100vh"
      ...
      <Box display="flex" gap={4} flexWrap="wrap" justifyContent="center">
        ...
        >
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Typography variant="h6">Connector B Info</Typography>
        ...
        {/* Right Panel - API Request Panel */}
        <Box width={700}>
          <ApiRequestPanelB
            title="Connector B API Tester"
            defaultMethod="GET"
            defaultEndpoint="/connectorb/api"
