...
const ApiRequestPanelB = ({
  title = "Connector B API Request",
  defaultMethod = "GET",
  ...
  // Common Connector B endpoints
  const endpointSuggestions = [
    "/connectorb/api",
    "/connectorb/api/artifacts",
    "/connectorb/api/brokers",
    "/connectorb/api/catalogs",
    "/connectorb/api/agreements",
  ];
...
export default ApiRequestPanelB;
